...
class Car(Transport):
    ...
    def stop_engine(self):
        print('Машина заглушила свой двигатель')
...
class Electroscooter(Transport):
    ...
    def start_engine(self):
        print('Whoosh мигнул светодиодом')

    def stop_engine(self):
        print('Whoosh мигнул светодиодом дважды')

    def move(self):
        print('Прохожие в ужасе разбегаются от очередного камикадзе (не правда:( )')
